...
function SummaryStatsCards({ statusCounts }: { statusCounts: Record<string, number> }) {
  return (
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="md:col-span-2 border-none shadow-md rounded-2xl">
                        ...
                        <CardContent>
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
{["summary-1", "summary-2", "summary-3", "summary-4"].map((k) => (
...
{["product-1", "product-2", "product-3"].map((k) => (
          <div key={k} className="space-y-2">
                                <div className="flex justify-between">
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Select value={range} onValueChange={(v) => { setRange(v); load(v); }}>
      ...
      <TopProductsCard topProducts={topProducts} maxProductQty={maxProductQty} />
    </div>
  );
}
