            ...
            <div className="space-y-24">
                <header className="space-y-6 max-w-3xl">
                    ...
                    <p className="text-xl text-muted-foreground font-medium leading-relaxed">
                        ...
                        efficiency and asset security. We leverage
                        high-performance logistics nodes to ensure rapid
                        delivery globally.
                    </p>
                </header>
                    ...
                    <div className="lg:col-span-7 space-y-16">
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-foreground font-medium leading-relaxed italic border-l-2 border-muted pl-8">
                                Most asset allocations are processed within 1-2
                                business cycles. Requests initiated during
                                non-operational periods will be queued for the
                                following business window.
                            </p>
                        </div>
                    ...
                    <div className="lg:col-span-5 sticky top-32">
                        <Card className="t-card border-none shadow-xl bg-primary text-primary-foreground p-10 space-y-6 overflow-hidden relative">
                            ...
                            <p className="text-sm font-medium leading-relaxed opacity-90">
                                Upon dispatch, your personal node dashboard will
                                be updated with a unique tracking identifier.
