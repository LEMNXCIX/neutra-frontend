                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
                    <div className="lg:col-span-5 space-y-8">
                        <p className="text-3xl font-semibold tracking-tight text-foreground leading-snug italic border-l-2 border-primary pl-8">
                            "Architecting minimal living through technical
                            precision and sustainable sourcing."
                        </p>
                    </div>

                    <div className="lg:col-span-7 space-y-8 text-muted-foreground font-medium text-lg leading-relaxed">
                        <p>
                            XCIX is a curated ecosystem of minimalist structures
                            and high-performance home assets. We believe in
                            intentional design that optimizes your spatial
                            environment without technical clutter.
                        </p>
                        <p>
                            Established in 2024, our objective is to provision
                            high-quality, ethically engineered pieces to modern
                            environments globally. Every asset in our catalog is
                            validated for craftsmanship, material integrity, and
                            timeless aesthetic performance.
                        </p>
                        <p>
                            We collaborate with specialized engineers and
                            designers who share our vision for functional
                            optimization. From raw material intake to final
                            logistics, we minimize environmental load while
                            maximizing the utility and beauty of our products.
                        </p>
                    </div>
                </div>
