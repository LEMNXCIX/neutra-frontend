...
4. [ ] **F4 — Align STORE coupon checkout.** Send coupon code, render validation/discount state, and handle reward coupon ownership and applicability.
5. [ ] **F5 — Verify and deliver.** Add focused tests, run full Vitest/typecheck/lint/build/diff checks, document build blockers, and create work-unit commits.
